...
func (m *MockCache) Has(ctx context.Context, key string) (bool, error) {
	m.ctrl.T.Helper()
...
func (m *MockCache) Set(ctx context.Context, key string, value any, ttlSeconds int) error {
	m.ctrl.T.Helper()
...
func (mr *MockCacheMockRecorder) Set(ctx, key, value, ttlSeconds any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Set", reflect.TypeOf((*MockCache)(nil).Set), ctx, key, value, ttlSeconds)
}
