...
import (
	...
	mailer "github.com/fatkulnurk/foundation/mailer"
...
func (m *MockMailer) SendMail(ctx context.Context, msg mailer.InputSendMail) (*mailer.OutputSendMail, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SendMail", ctx, msg)
	ret0, _ := ret[0].(*mailer.OutputSendMail)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// SendMail indicates an expected call of SendMail.
func (mr *MockMailerMockRecorder) SendMail(ctx, msg any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SendMail", reflect.TypeOf((*MockMailer)(nil).SendMail), ctx, msg)
}
